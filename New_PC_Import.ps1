...
# 6-7-2022:  v1.5 Removed the importing of the taskbar icons, while it worked often, sometimes it was more of a hinderance than a help and I want the script to be consistent
# 12-6-2022: v1.4 Reduced retry limit and wait time to 2 seconds each to prevent being caught in non-stop loop
# 25-5-2022: v1.3 Moved log location from root to Script logs folder. Added MT flag to robocopy to increase performance in some scenarios
# 5-5-2022:  v1.2.1 Added test for Downloads path based on change to the export script.
# 2-5-2022:  v1.2 Added transfer summary to end of script for quick identification of issues. Various minor spelling and error message wording changes.
# 29-4-2022: v1.1 Fixed Signatures not copying over correctly
# 13-4-2022: v1.0 Created a migration script for Windows 10 computers, copying files from the external drive and onto the new PC
